...
For the particular solution using the Method of Undetermined Coefficients:
Since 0 is not a root of the characteristic equation, we try a polynomial:
y = Ax² + Bx + C

Computing derivatives and substituting into the equation:
y' = 2Ax + B
y'' = 2A
y⁽³⁾ = y⁽⁴⁾ = 0

Substitution: 0 + 2·2A + (Ax² + Bx + C) = x² + 2x + 1
...
General solution: y = C₁cos(x) + C₂sin(x) + C₃x·cos(x) + C₄x·sin(x) + x² + 2x - 3`
